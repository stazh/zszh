...
function minVersion(given, required) {
...
const pbMixin = superclass => class PbMixin extends superclass {
  ...
  toAbsoluteURL(relative, server) {
    ...
    if (endpoint === '.') {
      base = new URL(window.location.href); // loaded in iframe
...
export { AttributePart as A, LitElement as L, NodePart as N, cmpVersion as a, clearPageEvents as b, css as c, directive as d, createMarker as e, reparentNodes as f, removeNodes as g, html as h, isPrimitive as i, minVersion as m, pbMixin as p, resolveURL as r };
//# sourceMappingURL=pb-mixin-ae9e2885.js.map
